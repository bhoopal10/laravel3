...
<!--                 </div>-->
                    ...
                    <table style="width: 100%" class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td style="width: 30px;height: 100px;<?php if($date['mday']==$days){ echo "background-color: darkolivegreen;";}if($days>date('t',$now) ||($i!=$begin) ){echo "background-color: #d3d3d3";} ?>"><?php if($i==$begin){if($days <= date('t',$now)){echo $days; $days++;} }?></td>
                            <?php }?>
                        </tr>
                            <?php }?>
                        </tbody>
